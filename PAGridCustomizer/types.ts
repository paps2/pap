...
export interface PAOneGridCustomizer {
  ...
  */
  ...
  groupIncludeFooter?: true; // include footer in group
  groupIncludeTotalFooter?: true; // include total footer in group
  expandByDefault?: -1; // expand all groups by default
  suppressRowClickSelection?: true; // disable row selection on click
  expandChildren?: true; // expand all children
...
export const RSTAT = '__row_status';
export const AGROW = 'ag-row';
export const GRCOL = '__group_column';
export const GRCNT = '__group_count';
